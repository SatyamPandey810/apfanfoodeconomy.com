...
<body>
    ...
    <div class="form-container">
        ...
        <form class="registration-form" id="pinForm" action="{{ route('refer.store') }}" method="post">
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="referId" name="referId" placeholder="Referral ID" value="{{$login_user}}" disabled />

                    <input  type="hidden" value="{{$user_id}}" name="user_posid">

                    <input  type="hidden" value="{{$login_user}}" name="referId">
            ...
            <div class="form-row radio-group">
                ...
                <label>
                    ...
                    <input type="radio" id="leftRadio" name="join" value="{{$user_position}}" class="form-check-input"  checked>LEFT

                </label>

                <label>

                    <input type="radio" id="rightRadio" name="join" value="R" class="form-check-input" disabled />RIGHT
                ...
                <label>
                    ...
                    <input type="radio" id="leftRadio" name="join" value="L" class="form-check-input" disabled />LEFT

                </label>

                <label>

                    <input type="radio" id="rightRadio" name="join" value="{{$user_position}}" class="form-check-input" checked>RIGHT
